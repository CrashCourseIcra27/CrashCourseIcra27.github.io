"""Low grip vehicle pair collision blocks lane (Town06).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "LowGripVehiclePairCollisionBlocksLaneTown06", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class LowGripVehiclePairCollisionBlocksLaneTown06(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(LowGripVehiclePairCollisionBlocksLaneTown06, self).__init__(
