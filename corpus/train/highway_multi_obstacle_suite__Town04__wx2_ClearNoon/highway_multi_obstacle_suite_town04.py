"""Highway multi obstacle suite (Town04).

A suite of highway obstacle encounters: lead reveal, work zone, shoulder truck, dark crash scene, aggressive merge, and a pedestrian crossing.
"""
...
from srunner.scenariomanager.scenarioatomics.custom_atomics_highway_multi_obstacle_suite_town04 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
...
class HighwayMultiObstacleSuiteTown04(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="HighwayMultiObstacleSuiteTown04",
