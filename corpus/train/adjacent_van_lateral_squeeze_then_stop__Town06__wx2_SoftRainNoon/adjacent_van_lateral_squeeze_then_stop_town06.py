"""Adjacent van lateral squeeze then stop (Town06).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "AdjacentVanLateralSqueezeThenStopTown06", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class AdjacentVanLateralSqueezeThenStopTown06(BasicScenario):
    timeout = 40
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        self._pursuer = None
        super(AdjacentVanLateralSqueezeThenStopTown06, self).__init__(
