"""Adjacent suv encroaches then stops (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "AdjacentSuvEncroachesThenStopsTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class AdjacentSuvEncroachesThenStopsTown13(BasicScenario):
    timeout = 50
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        self._suv = None
        super(AdjacentSuvEncroachesThenStopsTown13, self).__init__(
