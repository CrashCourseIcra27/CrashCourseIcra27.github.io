"""Adjacent van lateral squeeze then stop (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "AdjacentVanLateralSqueezeThenStopTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class AdjacentVanLateralSqueezeThenStopTown13(BasicScenario):
    timeout = 40
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        self._pursuer = None
        super(AdjacentVanLateralSqueezeThenStopTown13, self).__init__(
