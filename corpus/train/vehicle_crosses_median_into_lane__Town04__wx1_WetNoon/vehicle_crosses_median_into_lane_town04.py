"""Vehicle crosses median into lane (Town04).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "VehicleCrossesMedianIntoLaneTown04", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class VehicleCrossesMedianIntoLaneTown04(BasicScenario):
    timeout = 42
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(VehicleCrossesMedianIntoLaneTown04, self).__init__(
