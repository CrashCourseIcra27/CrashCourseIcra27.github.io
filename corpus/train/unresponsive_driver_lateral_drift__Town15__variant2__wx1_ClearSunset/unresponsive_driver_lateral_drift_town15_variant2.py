...
from srunner.scenariomanager.scenarioatomics.custom_atomics_unresponsive_driver_lateral_drift_town15_variant2 import (
    EgoSpeedGovernor,
    LaneCleaner,
...
class UnresponsiveDriverLateralDriftTown15Variant2(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="UnresponsiveDriverLateralDriftTown15Variant2",
    ...
    def _initialize_actors(self, config):
        ...
        if spawn_lane is None or spawn_lane.lane_type != carla.LaneType.Driving:
            raise RuntimeError("[UnresponsiveDriverLateralDriftTown15Variant2] No adjacent driving lane")
        ...
        if self._drifter is None:
            raise RuntimeError("[UnresponsiveDriverLateralDriftTown15Variant2] Failed to spawn drifter")
        ...
        print(
            f"\n[UnresponsiveDriverLateralDriftTown15Variant2] Spawn\n"
