"""Adjacent suv encroaches then stops (Town04).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "AdjacentSuvEncroachesThenStopsTown04", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class AdjacentSuvEncroachesThenStopsTown04(BasicScenario):
    timeout = 50
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        if (self._trigger_wp is None or self._trigger_wp.is_junction
                or self._trigger_wp.road_id != 38):
        ...
        self._suv = None
        super(AdjacentSuvEncroachesThenStopsTown04, self).__init__(
