"""Heavy truck slides across lanes (Town12).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "HeavyTruckSlidesAcrossLanesTown12", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class HeavyTruckSlidesAcrossLanesTown12(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        self._rig = None
        super(HeavyTruckSlidesAcrossLanesTown12, self).__init__(
