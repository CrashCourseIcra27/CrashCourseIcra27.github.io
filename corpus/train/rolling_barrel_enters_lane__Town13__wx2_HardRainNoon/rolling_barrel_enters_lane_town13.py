"""Rolling barrel enters lane (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "RollingBarrelEntersLaneTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class RollingBarrelEntersLaneTown13(BasicScenario):
    timeout = 40
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(RollingBarrelEntersLaneTown13, self).__init__(
