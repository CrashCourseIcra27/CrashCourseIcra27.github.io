...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "SwervingVehicleIntrusionAndReturnTown04Variant2", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class SwervingVehicleIntrusionAndReturnTown04Variant2(BasicScenario):
    timeout = 42
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        self._semi_spawn_m = _value(config, "semi_spawn_distance_m", 55.0, 42.0, 70.0)
        self._arm_m = _value(config, "arm_distance_m", 14.0, 10.0, 20.0)
        ...
        super(SwervingVehicleIntrusionAndReturnTown04Variant2, self).__init__(
    ...
    def _initialize_actors(self, config):
        ...
        semi_wp = _next(self._trigger_wp, self._semi_spawn_m)
    ...
    def _create_behavior(self):
        ...
        arm.add_child(InTriggerDistanceToVehicle(
            self.ego_vehicles[0], self._sedan, self._arm_m, name="A08DistanceArm"))
        arm.add_child(DriveDistance(self.ego_vehicles[0], 15.0, name="A08ProgressArm"))
        arm.add_child(WaypointFollower(self._sedan, self._sedan_speed, name="A08SedanApproach"))
