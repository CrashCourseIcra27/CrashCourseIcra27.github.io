"""Unresponsive driver lateral drift (Town15).
...
from srunner.scenariomanager.scenarioatomics.custom_atomics_unresponsive_driver_lateral_drift_town15_variant1 import (
    EgoSpeedGovernor,
    LaneCleaner,
...
class UnresponsiveDriverLateralDriftTown15Variant1(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="UnresponsiveDriverLateralDriftTown15Variant1",
    ...
    def _initialize_actors(self, config):
        ...
        if spawn_lane is None or spawn_lane.lane_type != carla.LaneType.Driving:
            raise RuntimeError("[UnresponsiveDriverLateralDriftTown15Variant1] No adjacent driving lane")
        ...
        if self._drifter is None:
            raise RuntimeError("[UnresponsiveDriverLateralDriftTown15Variant1] Failed to spawn drifter")
        ...
        print(
            f"\n[UnresponsiveDriverLateralDriftTown15Variant1] Spawn\n"
