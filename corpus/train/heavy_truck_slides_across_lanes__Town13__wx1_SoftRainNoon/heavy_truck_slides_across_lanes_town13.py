"""Heavy truck slides across lanes (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "HeavyTruckSlidesAcrossLanesTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class HeavyTruckSlidesAcrossLanesTown13(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        self._rig = None
        super(HeavyTruckSlidesAcrossLanesTown13, self).__init__(
