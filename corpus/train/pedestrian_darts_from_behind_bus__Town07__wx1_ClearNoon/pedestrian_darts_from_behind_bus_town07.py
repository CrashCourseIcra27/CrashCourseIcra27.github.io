"""Pedestrian darts from behind bus (Town07).
...
from srunner.scenariomanager.scenarioatomics.custom_atomics_pedestrian_darts_from_behind_bus_town07 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
)
...
class _RunSchoolChildCrossing(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        ...
        return py_trees.common.Status.RUNNING
class PedestrianDartsFromBehindBusTown07(BasicScenario):
    timeout = 120
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="PedestrianDartsFromBehindBusTown07",
