"""Low grip vehicle pair collision blocks lane (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "LowGripVehiclePairCollisionBlocksLaneTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class LowGripVehiclePairCollisionBlocksLaneTown13(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(LowGripVehiclePairCollisionBlocksLaneTown13, self).__init__(
