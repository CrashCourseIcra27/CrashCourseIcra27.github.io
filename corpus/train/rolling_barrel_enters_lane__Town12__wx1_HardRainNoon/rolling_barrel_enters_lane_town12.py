"""Rolling barrel enters lane (Town12).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "RollingBarrelEntersLaneTown12", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class RollingBarrelEntersLaneTown12(BasicScenario):
    timeout = 40
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(RollingBarrelEntersLaneTown12, self).__init__(
