...
from srunner.scenariomanager.scenarioatomics.custom_atomics_occluded_driveway_pullout_blocks_lane_town03_variant1 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
)
...
class OccludedDrivewayPulloutBlocksLaneTown03Variant1(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="OccludedDrivewayPulloutBlocksLaneTown03Variant1",
