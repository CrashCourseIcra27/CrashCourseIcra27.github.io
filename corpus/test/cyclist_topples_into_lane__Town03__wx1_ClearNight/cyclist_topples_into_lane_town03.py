"""Cyclist topples into lane (Town03).
...
from srunner.scenariomanager.scenarioatomics.custom_atomics_cyclist_topples_into_lane_town03 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
)
...
class CyclistTopplesIntoLaneTown03(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="CyclistTopplesIntoLaneTown03",
