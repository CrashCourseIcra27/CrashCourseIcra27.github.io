"""Oncoming vehicle head on intrusion (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "OncomingVehicleHeadOnIntrusionTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class OncomingVehicleHeadOnIntrusionTown13(BasicScenario):
    timeout = 50
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(OncomingVehicleHeadOnIntrusionTown13, self).__init__(
