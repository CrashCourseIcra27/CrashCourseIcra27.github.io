"""Lead vehicle brakes to full stop (Town04).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "LeadVehicleBrakesToFullStopTown04", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class LeadVehicleBrakesToFullStopTown04(BasicScenario):
    timeout = 40
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(LeadVehicleBrakesToFullStopTown04, self).__init__(
