"""Oncoming vehicle head on intrusion (Town01).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "OncomingVehicleHeadOnIntrusionTown01", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class OncomingVehicleHeadOnIntrusionTown01(BasicScenario):
    timeout = 50
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(OncomingVehicleHeadOnIntrusionTown01, self).__init__(
