"""Low grip adjacent vehicle spin blocks lane (Town06).
...
from srunner.scenariomanager.scenarioatomics.custom_atomics_low_grip_adjacent_vehicle_spin_blocks_lane_town06 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
...
class LowGripAdjacentVehicleSpinBlocksLaneTown06(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="LowGripAdjacentVehicleSpinBlocksLaneTown06",
