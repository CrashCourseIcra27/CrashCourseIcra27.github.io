"""Lead vehicle debris field and shoulder exit (Town06).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "LeadVehicleDebrisFieldAndShoulderExitTown06", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class LeadVehicleDebrisFieldAndShoulderExitTown06(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        if (self._trigger_wp is None or self._trigger_wp.is_junction
                or self._trigger_wp.road_id != 40):
        ...
        super(LeadVehicleDebrisFieldAndShoulderExitTown06, self).__init__(
