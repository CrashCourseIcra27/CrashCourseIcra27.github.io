"""Braking lead vehicle with lane debris (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "BrakingLeadVehicleWithLaneDebrisTown13Variant2", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class BrakingLeadVehicleWithLaneDebrisTown13Variant2(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(BrakingLeadVehicleWithLaneDebrisTown13Variant2, self).__init__(
    ...
    def _initialize_actors(self, config):
        ...
        layout = tuple((row, lateral) for row in (0.0, 1.8, 3.6)
                       for lateral in (0.0, 0.14, 0.28, 0.42))
