"""Lead vehicle debris field and shoulder exit (Town04).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "LeadVehicleDebrisFieldAndShoulderExitTown04", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class LeadVehicleDebrisFieldAndShoulderExitTown04(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        if (self._trigger_wp is None or self._trigger_wp.is_junction
                or self._trigger_wp.road_id != 45):
        ...
        super(LeadVehicleDebrisFieldAndShoulderExitTown04, self).__init__(
