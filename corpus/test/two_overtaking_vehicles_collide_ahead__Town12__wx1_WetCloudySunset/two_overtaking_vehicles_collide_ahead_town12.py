"""Two overtaking vehicles collide ahead (Town12).
...
ROAD_ID = 713  # Town06 -- see module docstring "Road geometry" for why this
...
def _emit_event(name, ego, actors, reason, extra=None):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "TwoOvertakingVehiclesCollideAheadTown12", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class TwoOvertakingVehiclesCollideAheadTown12(BasicScenario):
    timeout = 55
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(TwoOvertakingVehiclesCollideAheadTown12, self).__init__(
