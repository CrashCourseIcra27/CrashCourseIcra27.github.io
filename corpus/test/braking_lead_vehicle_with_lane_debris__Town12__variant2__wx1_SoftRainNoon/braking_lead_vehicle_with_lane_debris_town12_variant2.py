...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "BrakingLeadVehicleWithLaneDebrisTown12Variant2", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class BrakingLeadVehicleWithLaneDebrisTown12Variant2(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(BrakingLeadVehicleWithLaneDebrisTown12Variant2, self).__init__(
