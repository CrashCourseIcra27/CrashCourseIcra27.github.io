"""Tailgating vehicle rear end (Town13).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "TailgatingVehicleRearEndTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class TailgatingVehicleRearEndTown13(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(TailgatingVehicleRearEndTown13, self).__init__(
