"""Lead vehicle brakes to full stop (Town12).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "LeadVehicleBrakesToFullStopTown12", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class LeadVehicleBrakesToFullStopTown12(BasicScenario):
    timeout = 40
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        if (self._trigger_wp is None or self._trigger_wp.is_junction
                or self._trigger_wp.road_id != 837):
        ...
        super(LeadVehicleBrakesToFullStopTown12, self).__init__(
