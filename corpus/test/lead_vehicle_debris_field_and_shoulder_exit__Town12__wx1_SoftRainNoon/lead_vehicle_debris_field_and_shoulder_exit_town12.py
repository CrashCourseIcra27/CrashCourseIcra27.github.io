"""Lead vehicle debris field and shoulder exit (Town12).
...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "LeadVehicleDebrisFieldAndShoulderExitTown12", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class LeadVehicleDebrisFieldAndShoulderExitTown12(BasicScenario):
    timeout = 45
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(LeadVehicleDebrisFieldAndShoulderExitTown12, self).__init__(
