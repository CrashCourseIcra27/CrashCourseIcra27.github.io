...
from srunner.scenariomanager.scenarioatomics.custom_atomics_motorcycle_cuts_in_and_slows_town15_variant2 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
)
...
class MotorcycleCutsInAndSlowsTown15Variant2(BasicScenario):
    timeout = 180
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="MotorcycleCutsInAndSlowsTown15Variant2",
