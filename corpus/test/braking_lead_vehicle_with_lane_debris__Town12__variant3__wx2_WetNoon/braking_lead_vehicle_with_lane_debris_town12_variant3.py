...
def _emit_event(name, ego, actors, reason):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "BrakingLeadVehicleWithLaneDebrisTown12Variant3", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class BrakingLeadVehicleWithLaneDebrisTown12Variant3(BasicScenario):
    timeout = 60
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(BrakingLeadVehicleWithLaneDebrisTown12Variant3, self).__init__(
