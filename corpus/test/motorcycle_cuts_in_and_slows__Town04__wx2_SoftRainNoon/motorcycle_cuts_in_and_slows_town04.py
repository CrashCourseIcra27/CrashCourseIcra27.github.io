"""Motorcycle cuts in and slows (Town04).
...
from srunner.scenariomanager.scenarioatomics.custom_atomics_motorcycle_cuts_in_and_slows_town04 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
)
...
class MotorcycleCutsInAndSlowsTown04(BasicScenario):
    timeout = 180
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="MotorcycleCutsInAndSlowsTown04",
