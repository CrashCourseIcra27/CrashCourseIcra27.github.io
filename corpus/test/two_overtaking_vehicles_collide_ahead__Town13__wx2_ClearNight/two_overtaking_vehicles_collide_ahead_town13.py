"""Two overtaking vehicles collide ahead (Town13).
...
ROAD_ID = 946  # Town13 -- see module docstring "Road geometry" for why this
...
def _emit_event(name, ego, actors, reason, extra=None):
    ...
    try:
        ...
        item = {"event": name, "scenario_id": "TwoOvertakingVehiclesCollideAheadTown13", "revision": os.environ.get("SCENARIO_REVISION", "unknown"),
...
class TwoOvertakingVehiclesCollideAheadTown13(BasicScenario):
    timeout = 55
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        super(TwoOvertakingVehiclesCollideAheadTown13, self).__init__(
