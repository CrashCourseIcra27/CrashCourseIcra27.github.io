...
from srunner.scenariomanager.scenarioatomics.custom_atomics_cyclist_topples_into_lane_town11_variant2 import (
    EgoSpeedGovernor,
    HoldUntilEgoMoves,
    LaneCleaner,
)
...
class CyclistTopplesIntoLaneTown11Variant2(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config,
        ...
        super().__init__(
            name="CyclistTopplesIntoLaneTown11Variant2",
